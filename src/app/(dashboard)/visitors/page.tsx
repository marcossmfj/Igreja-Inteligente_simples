                    ...
                    <table className="w-full text-left border-collapse">
                      ...
                      <tbody className="divide-y divide-slate-50">
                        {visitors.map((visitor) => {
                          ...
                          const message = encodeURIComponent(`Olá *${visitor.name}*, foi um prazer enorme ter você conosco em nossa igreja! Esperamos que tenha se sentido acolhido(a). Qualquer dúvida, estamos à disposição.`)
